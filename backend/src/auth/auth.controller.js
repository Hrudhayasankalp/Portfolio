...
exports.forgotPassword = async (req, res) => {
  ...
  try {
    ...
    res.json({ msg: "An e-mail has been sent to " + admin.email + " with further instructions." });
  } catch (err) {
    console.error(err);
    res.status(500).json({ msg: "Error in forgot password process", error: err.message });
  }
};
